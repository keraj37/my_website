...
namespace my_website.Controllers.Console.Commands
{
    ...
    [ConsoleCommandVariable(KeyName = "ymin", Type = ConsoleCommandVariableAttribute.CommandValueType.FLOAT, DefaultValue = -2f)]
    [ConsoleCommandVariable(KeyName = "ymax", Type = ConsoleCommandVariableAttribute.CommandValueType.FLOAT, DefaultValue = 2f)]
    [ConsoleCommandVariable(KeyName = "xmin", Type = ConsoleCommandVariableAttribute.CommandValueType.FLOAT, DefaultValue = -2f)]
    [ConsoleCommandVariable(KeyName = "xmax", Type = ConsoleCommandVariableAttribute.CommandValueType.FLOAT, DefaultValue = 2f)]
